...
class BarangayOrdinanceView extends StatefulWidget {
  const BarangayOrdinanceView({super.key});

  @override
  State<BarangayOrdinanceView> createState() => _BarangayOrdinanceViewState();
}

class _BarangayOrdinanceViewState extends State<BarangayOrdinanceView> {
  String searchQuery = '';
